...
const __1 = require("ionic/lib/project");
...
class IonicAngularProject extends __1.Project {
    ...
    registerAilments(registry) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const ailments = yield Promise.resolve().then(() => require('ionic/lib/project/ionic-angular/ailments'));
    ...
    requireBuildRunner() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { IonicAngularBuildRunner } = yield Promise.resolve().then(() => require('ionic/lib/project/ionic-angular/build'));
            const deps = Object.assign({}, this.e, { project: this });
    ...
    requireServeRunner() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { IonicAngularServeRunner } = yield Promise.resolve().then(() => require('ionic/lib/project/ionic-angular/serve'));
            const deps = Object.assign({}, this.e, { project: this });
    ...
    requireGenerateRunner() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { IonicAngularGenerateRunner } = yield Promise.resolve().then(() => require('ionic/lib/project/ionic-angular/generate'));
            const deps = Object.assign({}, this.e, { project: this });
