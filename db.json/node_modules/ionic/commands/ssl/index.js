    ...
    getCommands() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return new namespace_1.CommandMap([
                ['generate', () => tslib_1.__awaiter(this, void 0, void 0, function* () { const { SSLGenerateCommand } = yield Promise.resolve().then(() => require('ionic/commands/ssl/generate')); return new SSLGenerateCommand(this); })],
                ['g', 'generate'],
            ]);
        });
    }
