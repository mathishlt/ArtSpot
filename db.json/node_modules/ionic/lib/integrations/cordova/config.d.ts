...
import { ProjectIntegration, ResourcesPlatform } from 'ionic/definitions';
...
export declare function loadConfigXml(integration: Required<ProjectIntegration>): Promise<ConfigXml>;
