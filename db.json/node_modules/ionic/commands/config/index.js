    ...
    getCommands() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return new namespace_1.CommandMap([
                ['get', () => tslib_1.__awaiter(this, void 0, void 0, function* () { const { ConfigGetCommand } = yield Promise.resolve().then(() => require('ionic/commands/config/get')); return new ConfigGetCommand(this); })],
                ['set', () => tslib_1.__awaiter(this, void 0, void 0, function* () { const { ConfigSetCommand } = yield Promise.resolve().then(() => require('ionic/commands/config/set')); return new ConfigSetCommand(this); })],
                ['unset', () => tslib_1.__awaiter(this, void 0, void 0, function* () { const { ConfigUnsetCommand } = yield Promise.resolve().then(() => require('ionic/commands/config/unset')); return new ConfigUnsetCommand(this); })],
            ]);
        });
    }
}
