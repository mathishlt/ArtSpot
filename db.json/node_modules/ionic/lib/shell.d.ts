...
import { ILogger, IShell, IShellOutputOptions, IShellRunOptions, IShellSpawnOptions } from 'ionic/definitions';
...
export declare class Shell implements IShell {
    ...
    spawn(command: string, args: string[], { showCommand, ...crossSpawnOptions }: IShellSpawnOptions): Promise<ChildProcess>;
