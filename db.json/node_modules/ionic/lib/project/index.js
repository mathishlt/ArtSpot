...
const guards_1 = require("ionic/guards");
const errors_1 = require("ionic/lib/errors");
const integrations_1 = require("ionic/lib/integrations");
...
function createProjectFromDetails(details, deps) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        switch (type) {
            case 'angular':
                const { AngularProject } = yield Promise.resolve().then(() => require('ionic/lib/project/angular'));
                return new AngularProject(details, deps);
            case 'ionic-angular':
                const { IonicAngularProject } = yield Promise.resolve().then(() => require('ionic/lib/project/ionic-angular'));
                return new IonicAngularProject(details, deps);
            case 'ionic1':
                const { Ionic1Project } = yield Promise.resolve().then(() => require('ionic/lib/project/ionic1'));
                return new Ionic1Project(details, deps);
            case 'custom':
                const { CustomProject } = yield Promise.resolve().then(() => require('ionic/lib/project/custom'));
        ...
        // new multi-app setup.
        if (context === 'multiapp') {
            const { BareProject } = yield Promise.resolve().then(() => require('ionic/lib/project/bare'));
...
class Project {
    ...
    registerAilments(registry) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const ailments = yield Promise.resolve().then(() => require('ionic/lib/doctor/ailments'));
