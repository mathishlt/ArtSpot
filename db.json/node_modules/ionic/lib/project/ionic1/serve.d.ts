import { CommandLineInputs, CommandLineOptions, CommandMetadata, Ionic1ServeOptions, ServeDetails } from 'ionic/definitions';
import { ServeRunner, ServeRunnerDeps } from 'ionic/lib/serve';
import { Ionic1Project } from 'ionic/lib/project/ionic1';
