 ...
 */
const dateRange_1 = __importDefault(require("pac-resolver/dist/dateRange"));
const dnsDomainIs_1 = __importDefault(require("pac-resolver/dist/dnsDomainIs"));
const dnsDomainLevels_1 = __importDefault(require("pac-resolver/dist/dnsDomainLevels"));
const dnsResolve_1 = __importDefault(require("pac-resolver/dist/dnsResolve"));
const isInNet_1 = __importDefault(require("pac-resolver/dist/isInNet"));
const isPlainHostName_1 = __importDefault(require("pac-resolver/dist/isPlainHostName"));
const isResolvable_1 = __importDefault(require("pac-resolver/dist/isResolvable"));
const localHostOrDomainIs_1 = __importDefault(require("pac-resolver/dist/localHostOrDomainIs"));
const myIpAddress_1 = __importDefault(require("pac-resolver/dist/myIpAddress"));
const shExpMatch_1 = __importDefault(require("pac-resolver/dist/shExpMatch"));
const timeRange_1 = __importDefault(require("pac-resolver/dist/timeRange"));
const weekdayRange_1 = __importDefault(require("pac-resolver/dist/weekdayRange"));
/**
