...
If you are having issues setting up SSH keys, please get in touch with our Support[^support-request].
    ...
    run(inputs, options, runinfo) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { getGeneratedPrivateKeyPath } = yield Promise.resolve().then(() => require('ionic/lib/ssh'));
            const { getConfigPath } = yield Promise.resolve().then(() => require('ionic/lib/ssh-config'));
