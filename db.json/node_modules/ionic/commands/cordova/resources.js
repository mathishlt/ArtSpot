...
const logger_1 = require("ionic/lib/utils/logger");
const npm_1 = require("ionic/lib/utils/npm");
const base_1 = require("ionic/commands/cordova/base");
...
With the experimental ${chalk_1.default.green('--cordova-res')} option, ${chalk_1.default.green('ionic cordova resources')} will generate resources locally using the ${chalk_1.default.green('cordova-res')} utility[^cordova-res-repo].
    ...
    getBuildPlatforms() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { getPlatforms } = yield Promise.resolve().then(() => require('ionic/lib/integrations/cordova/project'));
            const { RESOURCES } = yield Promise.resolve().then(() => require('ionic/lib/integrations/cordova/resources'));
    ...
    runResourceServer(platform, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { loadConfigXml } = yield Promise.resolve().then(() => require('ionic/lib/integrations/cordova/config'));
            const { addResourcesToConfigXml, createImgDestinationDirectories, findMostSpecificSourceImage, getImageResources, getSourceImages, transformResourceImage, uploadSourceImage } = yield Promise.resolve().then(() => require('ionic/lib/integrations/cordova/resources'));
            const { force } = options;
