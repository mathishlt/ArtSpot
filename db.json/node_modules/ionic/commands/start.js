...
const constants_1 = require("ionic/constants");
const command_1 = require("ionic/lib/command");
const errors_1 = require("ionic/lib/errors");
const executor_1 = require("ionic/lib/executor");
const project_1 = require("ionic/lib/project");
const shell_1 = require("ionic/lib/shell");
const emoji_1 = require("ionic/lib/utils/emoji");
...
Use the ${chalk_1.default.green('--type')} option to start projects using older versions of Ionic. For example, you can start an Ionic 3 project with ${chalk_1.default.green('--type=ionic-angular')}. Use ${chalk_1.default.green('--list')} to see all project types and templates.
    ...
    preRun(inputs, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { promptToLogin } = yield Promise.resolve().then(() => require('ionic/lib/session'));
            const starterTemplates = yield this.getStarterTemplates();
            ...
            if (!inputs[0]) {
                if (appflowId) {
                    const { AppClient } = yield Promise.resolve().then(() => require('ionic/lib/app'));
    ...
    run(inputs, options, runinfo) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { pkgManagerArgs } = yield Promise.resolve().then(() => require('ionic/lib/utils/npm'));
            const { getTopLevel, isGitInstalled } = yield Promise.resolve().then(() => require('ionic/lib/git'));
            const { getIonicDevAppText, getIonicProText } = yield Promise.resolve().then(() => require('ionic/lib/start'));
            if (!this.schema) {
    ...
    getStarterTemplates() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { STARTER_TEMPLATES } = yield Promise.resolve().then(() => require('ionic/lib/start'));
    ...
    findStarterTemplate(template, type, tag) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { STARTER_BASE_URL, getStarterList } = yield Promise.resolve().then(() => require('ionic/lib/start'));
            const starterTemplates = yield this.getStarterTemplates();
    ...
    loadManifest(manifestPath) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { readStarterManifest } = yield Promise.resolve().then(() => require('ionic/lib/start'));
            try {
    ...
    downloadStarterTemplate(projectDir, starterTemplate) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { createRequest, download } = yield Promise.resolve().then(() => require('ionic/lib/utils/http'));
            const { tar } = yield Promise.resolve().then(() => require('ionic/lib/utils/archive'));
            const tasks = this.createTaskChain();
