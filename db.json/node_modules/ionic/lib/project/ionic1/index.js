...
class Ionic1Project extends __1.Project {
    ...
    requireBuildRunner() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { Ionic1BuildRunner } = yield Promise.resolve().then(() => require('ionic/lib/project/ionic1/build'));
    ...
    requireServeRunner() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { Ionic1ServeRunner } = yield Promise.resolve().then(() => require('ionic/lib/project/ionic1/serve'));
            const deps = Object.assign({}, this.e, { project: this });
