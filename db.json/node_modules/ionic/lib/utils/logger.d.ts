...
import { ILogger } from 'ionic/definitions';
...
export declare function createDefaultLoggerHandlers(formatter?: LoggerFormatter): Set<import("@ionic/cli-framework").StreamHandler>;
