...
class SSHListCommand extends base_1.SSHBaseCommand {
    ...
    run(inputs, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { SSHKeyClient } = yield Promise.resolve().then(() => require('ionic/lib/ssh'));
            const { findHostSection, getConfigPath, isDirective, loadFromPath } = yield Promise.resolve().then(() => require('ionic/lib/ssh-config'));
            const { json } = options;
