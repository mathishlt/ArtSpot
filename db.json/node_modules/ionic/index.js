...
const commands_1 = require("ionic/commands");
const guards_1 = require("ionic/guards");
const lib_1 = require("ionic/lib");
const executor_1 = require("ionic/lib/executor");
const init_1 = require("ionic/lib/init");
tslib_1.__exportStar(require("ionic/constants"), exports);
tslib_1.__exportStar(require("ionic/guards"), exports);
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (err) {
            ...
            if (err instanceof cli_framework_1.InputValidationError) {
                ...
                const { formatSuperAgentError } = yield Promise.resolve().then(() => require('ionic/lib/http'));
...
function receive(msg) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (msg.type === 'telemetry') {
            const { sendCommand } = yield Promise.resolve().then(() => require('ionic/lib/telemetry'));
            yield sendCommand({
                getInfo: env.getInfo,
                client: env.client,
                config: env.config,
