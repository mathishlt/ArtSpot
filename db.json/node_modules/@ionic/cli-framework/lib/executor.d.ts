...
import { CommandInstanceInfo, CommandMetadata, CommandMetadataInput, CommandMetadataOption, ICommand, IExecutor, INamespace, NamespaceLocateResult } from '@ionic/cli-framework/definitions';
import * as ζipc from '@ionic/cli-framework/utils/ipc';
import { Colors } from '@ionic/cli-framework/lib/colors';
import { Command, Namespace } from '@ionic/cli-framework/lib/command';
import { CommandHelpSchema, NamespaceHelpSchema } from '@ionic/cli-framework/lib/help';
