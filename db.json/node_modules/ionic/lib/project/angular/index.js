...
class AngularProject extends __1.Project {
    ...
    requireBuildRunner() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { AngularBuildRunner } = yield Promise.resolve().then(() => require('ionic/lib/project/angular/build'));
    ...
    requireServeRunner() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { AngularServeRunner } = yield Promise.resolve().then(() => require('ionic/lib/project/angular/serve'));
            const deps = Object.assign({}, this.e, { project: this });
    ...
    requireGenerateRunner() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { AngularGenerateRunner } = yield Promise.resolve().then(() => require('ionic/lib/project/angular/generate'));
            const deps = Object.assign({}, this.e, { project: this });
