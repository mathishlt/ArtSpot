    ...
    getCommands() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return new namespace_1.CommandMap([
                ['syncmaps', () => tslib_1.__awaiter(this, void 0, void 0, function* () { const { MonitoringSyncSourcemapsCommand } = yield Promise.resolve().then(() => require('ionic/commands/monitoring/syncmaps')); return new MonitoringSyncSourcemapsCommand(this); })],
            ]);
        });
    }
}
