...
class BaseExecutor extends AbstractExecutor {
    ...
    rpc() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { RPCProcess } = yield Promise.resolve().then(() => require('@ionic/cli-framework/utils/ipc'));
