...
import { IAilmentRegistry, IClient, IConfig, IIntegration, ILogger, IMultiProjectConfig, IProject, IProjectConfig, ISession, IShell, InfoItem, IntegrationName, IonicContext, IonicEnvironmentFlags, PackageJson, ProjectIntegration, ProjectPersonalizationDetails, ProjectType } from 'ionic/definitions';
import * as ζbuild from 'ionic/lib/build';
import { BaseException } from 'ionic/lib/errors';
import * as ζgenerate from 'ionic/lib/generate';
import * as ζserve from 'ionic/lib/serve';
