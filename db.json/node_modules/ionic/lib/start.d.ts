import { IConfig, StarterList, StarterManifest, StarterTemplate } from 'ionic/definitions';
...
export declare function getIonicDevAppText(): Promise<string>;
export declare function getIonicProText(): Promise<string>;
