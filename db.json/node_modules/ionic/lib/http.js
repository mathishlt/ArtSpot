...
const http_1 = require("ionic/lib/utils/http");
...
class Client {
    ...
    make(method, path) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const { req } = yield http_1.createRequest(method, url, this.config.getHTTPConfig());
            req
...
class Paginator {
    constructor({ client, reqgen, guard, state, max }) {
        ...
        this.max = max;
        if (!state) {
            state = Object.assign({ page_size: 100 }, defaultState);
        }
...
function formatSuperAgentError(e) {
    ...
    return chalk_1.default.red.bold(f);
}
...
function formatResponseError(req, status, body) {
    return chalk_1.default.red(`Request: ${req.method} ${req.url}\n` +
