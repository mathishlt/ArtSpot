...
const events_2 = require("ionic/lib/events");
const hooks_1 = require("ionic/lib/hooks");
...
class ServeRunner {
    ...
    gatherDevAppDetails(options, details) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (options.devapp) {
                const { computeBroadcastAddress } = yield Promise.resolve().then(() => require('ionic/lib/devapp'));
    ...
    publishDevApp(options, details) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (options.devapp) {
                const { createCommServer, createPublisher } = yield Promise.resolve().then(() => require('ionic/lib/devapp'));
