...
import { ObservableInput, ObservedValuesFromArray, ObservedValueOf, SubscribableOrPromise } from 'rxjs/src/internal/types';
...
import { isObservable } from 'rxjs/src/internal/util/isObservable';
